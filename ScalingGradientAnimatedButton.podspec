...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ScalingGradientAnimatedButton.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Antonio Ruffolo/ScalingGradientAnimatedButton'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Antonio Ruffolo' => 'antonioruffolo2@gmail.com' }
  s.source           = { :git => 'https://github.com/Antonio Ruffolo/ScalingGradientAnimatedButton.git', :tag => s.version.to_s }
